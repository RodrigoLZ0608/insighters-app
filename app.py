...
with st.container():
    ...
    # Menú horizontal
    with col_menu:
    # Columna vacía que hace de relleno
        spacer, btn1, btn2, btn3, btn4, btn5 = st.columns([5, 2, 2, 2, 2, 2])
...
# Botón a la derecha del todo (extremo derecho)
with col_btn:
...
st.divider()
with st.container():
    st.subheader("Comercializas servicios o productos pero no estás llegando  a tus metas de ventas. ¿Por qué?")
    ...
    with st.container():
        ...
        items = [
            ...
            ("⚙️", "No tienes la tecnología ni procesos para automatizar, fidelizar y generar recomprar.")
        ]
